jQuery(document).ready(function($) {
  ...
  $(document).on('click', '.items-list-button', function() {
    ...
    $ul.prepend($('<li class="item"><div class="move glyphicon glyphicon-menu-hamburger"></div><a href="#remove" class="glyphicon glyphicon-remove remove" title="Remove Item"></a><input type="text" name="'+name+'[]" /></li>').hide().delay(10).slideDown(150).scrollTop('100%'));
  });
